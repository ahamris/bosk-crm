...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $clients = [
            // Existing clients
            ['first_name' => 'Maria', 'last_name' => 'Bakker', 'email' => 'maria.bakker@example.com', 'phone' => '+31 6 1234 5678', 'gender' => 'female', 'date_of_birth' => '1985-03-15', 'address' => 'Kleiweg 45', 'city' => 'Gouda', 'postal_code' => '2801 JB', 'skin_type' => 'sensitive', 'source' => 'walk_in', 'preferred_contact' => 'email', 'marketing_consent' => true, 'medical_notes' => 'Allergie voor parabenen.'],
            ['first_name' => 'Anna', 'last_name' => 'de Jong', 'email' => 'anna.dejong@example.com', 'phone' => '+31 6 2345 6789', 'gender' => 'female', 'date_of_birth' => '1990-07-22', 'address' => 'Markt 22', 'city' => 'Gouda', 'postal_code' => '2801 JH', 'skin_type' => 'combination', 'source' => 'website', 'preferred_contact' => 'whatsapp', 'marketing_consent' => true],
            ['first_name' => 'Fatima', 'last_name' => 'El Amrani', 'email' => 'fatima@example.com', 'phone' => '+31 6 3456 7890', 'gender' => 'female', 'date_of_birth' => '1988-11-03', 'address' => 'Bodegraafsestraatweg 10', 'city' => 'Gouda', 'postal_code' => '2808 PA', 'skin_type' => 'oily', 'source' => 'referral', 'preferred_contact' => 'phone', 'marketing_consent' => false, 'medical_notes' => 'Hormoongebonden acne.'],
            ['first_name' => 'Peter', 'last_name' => 'Visser', 'email' => 'peter.visser@example.com', 'phone' => '+31 6 4567 8901', 'gender' => 'male', 'date_of_birth' => '1975-01-30', 'address' => 'Graaf Florisweg 88', 'city' => 'Gouda', 'postal_code' => '2805 AM', 'skin_type' => 'normal', 'source' => 'walk_in', 'preferred_contact' => 'email', 'marketing_consent' => false],
            ['first_name' => 'Svetlana', 'last_name' => 'Ivanova', 'email' => 'svetlana@example.com', 'phone' => '+31 6 5678 9012', 'gender' => 'female', 'locale' => 'ru', 'date_of_birth' => '1992-05-18', 'address' => 'Joubertstraat 3', 'city' => 'Gouda', 'postal_code' => '2802 LE', 'skin_type' => 'dry', 'source' => 'social_media', 'preferred_contact' => 'whatsapp', 'marketing_consent' => true, 'medical_notes' => 'Gevoelige huid in zone decollete.'],

            // New clients
            ['first_name' => 'Sophie', 'last_name' => 'van den Berg', 'email' => 'sophie@email.nl', 'phone' => '+31 6 9876 5432', 'gender' => 'female', 'date_of_birth' => '1990-07-22', 'address' => 'Westhaven 12', 'city' => 'Gouda', 'postal_code' => '2801 PJ', 'skin_type' => 'normal', 'source' => 'website', 'preferred_contact' => 'email', 'marketing_consent' => true],
            ['first_name' => 'Emma', 'last_name' => 'de Groot', 'email' => 'emma.degroot@gmail.com', 'phone' => '+31 6 5555 1234', 'gender' => 'female', 'date_of_birth' => '1988-11-03', 'address' => 'Spoorstraat 7', 'city' => 'Gouda', 'postal_code' => '2802 BA', 'skin_type' => 'combination', 'source' => 'referral', 'preferred_contact' => 'sms', 'marketing_consent' => true],
            ['first_name' => 'Anna', 'last_name' => 'Jansen', 'email' => 'anna.j@outlook.nl', 'phone' => '+31 6 4321 8765', 'gender' => 'female', 'date_of_birth' => '1995-02-14', 'address' => 'Kattensingel 50', 'city' => 'Gouda', 'postal_code' => '2801 JE', 'skin_type' => 'oily', 'source' => 'social_media', 'preferred_contact' => 'whatsapp', 'marketing_consent' => false],
            ['first_name' => 'Lisa', 'last_name' => 'Bakker', 'email' => 'lisa.b@hotmail.nl', 'phone' => '+31 6 6789 1234', 'gender' => 'female', 'date_of_birth' => '1982-09-18', 'address' => 'Turfmarkt 33', 'city' => 'Gouda', 'postal_code' => '2801 HA', 'skin_type' => 'sensitive', 'source' => 'walk_in', 'preferred_contact' => 'phone', 'marketing_consent' => true, 'medical_notes' => 'Eczeem op onderarmen.'],
            ['first_name' => 'Nadia', 'last_name' => 'Youssef', 'email' => 'nadia.y@email.nl', 'phone' => '+31 6 3456 7890', 'gender' => 'female', 'date_of_birth' => '1993-04-07', 'address' => 'Ridder van Catsweg 120', 'city' => 'Gouda', 'postal_code' => '2805 LG', 'skin_type' => 'dry', 'source' => 'referral', 'preferred_contact' => 'email', 'marketing_consent' => true],
        ];
